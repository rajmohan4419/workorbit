...
globalThis.ORBITBOARD_TOOLS = [
  // Career
  {
    ...
    category: 'Career',
    icon: '₹',
    keywords: 'salary in hand take home ctc payroll monthly gross net pay tax regime pf provident fund pay slip compensation appraisal'
  },
  {
    slug: 'salary-hike',
  ...
  },
  {
    ...
    category: 'Everyday',
    icon: 'CSV',
    keywords: 'csv to json convert table array objects parse data export'
  },
  {
    slug: 'csv-to-xlsx',
  ...
  },
  {
    ...
    category: 'Developer',
    icon: 'JWT',
    keywords: 'jwt decoder json web token payload header claim exp expiration auth bearer token inspect'
  },
  {
    slug: 'unix-timestamp',
  ...
  },
  {
    ...
    category: 'Developer',
    icon: 'XML',
    keywords: 'json to xml convert parse data structure markup'
  },
  {
    slug: 'xml-to-json',
    ...
    category: 'Developer',
    icon: 'XML',
    keywords: 'xml to json convert parse data structure xml parser'
  },
  {
  ...
  },
  {
    ...
    category: 'Developer',
    icon: '↔',
    keywords: 'json to csv convert array table excel sheet data export'
  },
  {
    slug: 'json-to-xlsx',
    ...
    category: 'Developer',
    icon: 'XLS',
    keywords: 'json to xlsx convert array excel workbook spreadsheet excel export'
  }
];

if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    TOOLS: globalThis.ORBITBOARD_TOOLS,
    BASE_URL: globalThis.ORBITBOARD_BASE_URL
  };
}
