...
import { Settings, Users, Shield, Trash2, Save, UserMinus, ShieldAlert, AlertTriangle } from 'lucide-react'
...
export default function SettingsPage() {
  ...
  const isAdmin = members.find(m => m.user_id === currentUser?.id)?.role === 'admin' || isOwner
                ...
                <form onSubmit={handleUpdate} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-gray-400 text-sm">orbitboard.in/w/</span>
                      <input
                        value={slug}
